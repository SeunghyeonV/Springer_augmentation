...
def input_savedir_M1():
    ## get filename
    default_address = "/home/json/Desktop/CIFAR100_reconstruction/cifar100_output/randaug_M2/model_accuracy/"
...
def output_savedir_M1():
    ## get filename
    default_address = "/home/json/Desktop/CIFAR100_reconstruction/cifar100_output/randaug_M2/attack_accuracy/"
    augmentation_list = os.listdir(default_address)
    # print(augmentation_list) # -> returns augmentation list
    augmentation_list.sort()

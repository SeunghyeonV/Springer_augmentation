class DPSGD(Optimizer):
    ...
    def __init__(self, params, lr=required, momentum=0, dampening=0, weight_decay=0, nesterov=False, maximize=False, l2_norm_clip=required, noise_multiplier=required, batch_size=required):
